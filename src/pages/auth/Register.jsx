    ...
    <div className="py-3">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <label className="flex items-start gap-3 text-[13px] leading-relaxed text-[#34485C]">
          ...
          <span>
            I agree to the{" "}
            <span className="text-[#C7A765]">Terms & Conditions</span> and{" "}
            <span className="text-[#C7A765]">Privacy Policy</span>
          </span>
        </label>
      ...
      <div className="my-7 flex items-center gap-4">
        ...
        <p className="text-[13px] text-[#6F7B86]">or sign up with</p>
        <div className="h-px flex-1 bg-[#DDE1E6]" />
      </div>
      ...
      <p className="mt-7 text-center text-[13px] text-[#34485C]">
        ...
        <Link to="/login" className="text-[#C7A765] hover:text-[#9C7A3F]">
          Sign in
        </Link>
      </p>
    </div>
